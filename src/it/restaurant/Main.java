...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Piatto formaggi= new Piatto("Tagliere di formaggi",17.50, TypePortataEnum.PRIMI,CategoriesEnum.VEGETARIANO);
        Bevanda cosmopolitan = new Bevanda("Cosmopolitan", 8.50,true,false);
        cosmopolitan.stampaDettagli();
        formaggi.stampaDettagli();

        Piatto tagliereSalumi= new Piatto("Tagliere di salumi",17.50, TypePortataEnum.ANTIPASTI,CategoriesEnum.BASECARNE);
        Piatto carbonara= new Piatto("Carbonara",17.50, TypePortataEnum.PRIMI,CategoriesEnum.BASECARNE);
        Piatto amatriciana= new Piatto("Amatriciana",17.50, TypePortataEnum.PRIMI,CategoriesEnum.BASECARNE);
